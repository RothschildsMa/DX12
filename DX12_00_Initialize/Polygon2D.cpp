...
void Polygon2D::Draw()
{
...

	{
		...
		XMMATRIX projection;
		projection = XMMatrixOrthographicOffCenterLH(0.0f, static_cast<float>(renderManager->GetBackBufferWidth()), static_cast<float>(renderManager->GetBackBufferHeight()), 0.0f, 0.0f, 1.0f);
